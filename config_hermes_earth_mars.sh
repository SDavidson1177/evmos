...
# hermes --config config.toml create channel --a-chain evmos_9000-4 --b-chain evmos_9000-5 --a-port chat --b-port chat --channel-version chat-1 --new-client-connection
