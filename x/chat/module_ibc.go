...
func (im IBCModule) OnAcknowledgementPacket(
	...
	switch packet := modulePacketData.Packet.(type) {
	case *types.ChatPacketData_IbcChatPacket:
		err := im.keeper.OnAcknowledgementIbcChatPacket(ctx, modulePacket, *packet.IbcChatPacket, ack)
		if err != nil {
			return err
		}
		eventType = types.EventTypeIbcChatPacket
...
func (im IBCModule) OnTimeoutPacket(
	...
	switch packet := modulePacketData.Packet.(type) {
	case *types.ChatPacketData_IbcChatPacket:
		err := im.keeper.OnTimeoutIbcChatPacket(ctx, modulePacket, *packet.IbcChatPacket)
		if err != nil {
			return err
		}
